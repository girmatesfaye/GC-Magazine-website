        ...
        <div className="max-w-7xl mx-auto px-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-5">
              ...
              <a className="text-on-surface-variant hover:text-primary transition-all" href="https://www.tiktok.com/@girma_thoughts" aria-label="TikTok" target="_blank" rel="noopener noreferrer">
                <svg className="w-4 h-4" role="img" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
